...
/// This view modifier can apply a swipe gesture to any view,
/// to trigger actions when swiping in certain directions.
///
/// You can apply it with ``SwiftUICore/View/onSwipeGesture(maximumTime:minimumDistance:maximumDistance:gestureTimer:up:left:right:down:)``.
